...
var Handlers = function () {
    ...
    (0, _createClass3.default)(Handlers, [{
        ...
        value: function _handleClick(event) {
            var eventLink = event.target.closest('a');

            if (!eventLink) {
                return;
            }

            var activeLink = this._el.querySelector('.disabled');
...
var RequestForJSON = function () {
    function RequestForJSON(options) {
...
exports.default = RequestForJSON;
